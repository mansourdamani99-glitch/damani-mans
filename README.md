...
<div class="container">
    ...
    <!-- تطبيقنا (كانت طلباتي سابقاً) -->
    <div id="ourapp" class="page">
        <h2 class="glow-text">📱 تطبيقنا - الحقني في جيبك</h2>
        ...
        window.addEventListener('devicemotion', (e) => {
            ...
            if(acc && (Math.abs(acc.x) > 15 || Math.abs(acc.y) > 15 || Math.abs(acc.z) > 15)) {
                ...
                if(now - lastShake > 1500) {
                    lastShake = now;
                    if(confirm('🚨 هزاز الهاتف تم تفعيله! هل تريد طلب مساعدة عاجلة؟')) alert('يمكنك طلب المساعدة من خلال خدماتنا عبر القائمة.');
                }
            }
        });
    }
